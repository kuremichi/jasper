...
class JasperEngine {
    constructor(ruleStore, options = exports.DefaultEngineOptions) {
    ...
    processCompoundDependency(context, compoundDependency) {
        ...
        const tasks = lodash_1.default.reduce(compoundDependency.rules, (acc, rule) => {
            if (rule_config_1.isSimpleDependency(rule)) {
                ...
                acc[rule.name] = this.processCompoundDependency(context, childCompoundDependency).pipe(operators_1.switchMap((r) => {
