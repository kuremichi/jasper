...
var JasperEngine = (function () {
    ...
    JasperEngine.prototype.processCompositeDependency = function (compositeDependency, context) {
        ...
        return rxjs_1.of(1).pipe(operators_1.switchMap(function () {
            ...
            return compositeDependency.when
                ? _this.processExpression(compositeDependency.when, context).pipe(operators_1.switchMap(function (whenResult) {
                    var w = lodash_1["default"].get(whenResult, '[0]', false);
                    return rxjs_1.of(w);
                }))
                : rxjs_1.of(true);
        }), operators_1.switchMap(function (run) {
            ...
            return compositeDependency.onDependencyError
                ? compositeDependency.onDependencyError(err, dependencyResponse, context).pipe(operators_1.tap(function () {
                    dependencyResponse.completeTime = new Date();
                }))
    ...
    JasperEngine.prototype.processSimpleDependency = function (simpleDependency, context) {
        ...
        return rxjs_1.of(true).pipe(operators_1.switchMap(function () {
            dependencyResponse.startTime = new Date();
            return simpleDependency.when
                ? _this.processExpression(simpleDependency.when, context).pipe(operators_1.switchMap(function (whenResult) {
                    var w = lodash_1["default"].get(whenResult, '[0]', false);
                    return rxjs_1.of(w);
                }))
                : rxjs_1.of(true);
                    ...
                    var tasks = lodash_1["default"].map(pathObjects, function (pathObject, index) {
                        ...
                        var task = rxjs_1.of(pathObject).pipe(operators_1.switchMap(function (pathObject) {
                            ...
                            if (executionResponse.hasError &&
                                ...
                                return simpleDependency.onEachError(response.error, executionResponse, context).pipe(operators_1.tap(function () {
            ...
            return simpleDependency.onDependencyError
                ? simpleDependency.onDependencyError(err, dependencyResponse, context).pipe(operators_1.tap(function () {
                    dependencyResponse.completeTime = new Date();
                }))
        ...
        return this.ruleStore.get(params.ruleName).pipe(operators_1.catchError(function (err) {
            ...
            return rxjs_1.of(rule).pipe(operators_1.switchMap(function (rule) {
                ...
                if (!context || _this.options.suppressDuplicateTasks !== true) {
                    ...
                    var direction_1 = rule.direction || enum_1.Direction.OutsideIn;
                    context = {
                        contextId: contextId,
                        rule: rule,
                        root: params.root,
                    ...
                    var action_1 = rxjs_1.defer(function () {
                        if (rule.action) {
                        ...
                        return _this.options.recipe === enum_1.EngineRecipe.BusinessProcessEngine ? rxjs_1.of(null) : rxjs_1.of(true);
                    }).pipe(operators_1.tap(function (result) {
                        context.complete = true;
                        context.response.isSuccessful = true;
                        context.response.result = result;
                    }));
                    var dependency_1 = rxjs_1.defer(function () {
                    ...
                    context._process$ = rxjs_1.of(true).pipe(operators_1.switchMap(function () {
                        ...
                        return direction_1 === enum_1.Direction.OutsideIn ? action_1 : dependency_1;
                    }), operators_1.switchMap(function () {
                        return direction_1 === enum_1.Direction.OutsideIn ? dependency_1 : action_1;
                    }), operators_1.switchMap(function () {
