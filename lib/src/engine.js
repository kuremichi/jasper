...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "rxjs", "rxjs/operators", "jsonata", "object-hash", "lodash", "./engine.option", "./dependency/simple.dependency", "./enum", "./store/rule.store.interfafce", "./ILogger"], factory);
    }
