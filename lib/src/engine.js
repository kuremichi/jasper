        ...
        return (compositeDependency.when
            ...
            return (compositeDependency.beforeDependency
                ...
                return (executionOrder == enum_1.ExecutionOrder.Sequential
                    ...
                    : rxjs_1.from(tasks).pipe(operators_1.mergeAll(compositeDependency.maxConcurrency), operators_1.toArray())).pipe(operators_1.switchMap((responses) => {
                    ...
                    context._process$ = rxjs_1.of(true).pipe(operators_1.switchMap(() => {
                        ...
                        if (rule.onError) {
                            if (typeof rule.onError === 'string') {
                                ...
                                try {
                                    const errExpression = jsonata_1.default(rule.onError);
